...
const Question2 = () => {
    ...
    if (error) return <div>something went wrong you have to Refresh page..</div>
    // console.log(data)
        ...
        <div>
            <div className='row__1'>
                <div className='col__1'>
                    ...
                    <div className='col__1sub' >
                        <h1>{data.Frontpage[0].title}</h1>

                        <p style={{ marginTop: '15px' }}>{data.Frontpage[0].description}</p>
                    </div>
                </div>
            ...
            <div className='row__5'>
                ...
                <div className='row__5btnmain'>
                    ...
                    {data.Button && data.Button.map((elem, ind) => {

                        return (
                            <div className='row__5btn' key={ind} ><p>{elem.btn}</p></div>
                        )
                    })}
